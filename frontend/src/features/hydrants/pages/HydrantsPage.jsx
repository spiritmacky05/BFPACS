        ...
        <div className="flex gap-3 flex-wrap">
          ...
          {nearby !== null && (
            <button
              ...
              className="px-3 py-2 rounded-lg border border-[#2a2a2a] text-gray-400 hover:text-white text-sm"
            >
              Clear
            </button>
          )}
            ...
            <div className="bg-[#111] border border-[#1f1f1f] rounded-xl p-6 space-y-4">
              ...
              {canEdit && (
                <div className="flex gap-2 pt-2 border-t border-[#1f1f1f]">
                  <button
                    onClick={() => { openEdit(h); setSelectedHydrant(null); }}
                  ...
                  {isAdmin && (
                    <button
                      onClick={() => { handleDelete(h); setSelectedHydrant(null); }}
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={form.hydrant_type}
                    onChange={e => setForm({ ...form, hydrant_type: e.target.value })}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    min={0}
                    value={form.psi}
                    onChange={e => setForm({ ...form, psi: e.target.value })}
                    placeholder="e.g. 60"
                    className="w-full bg-[#0d0d0d] border border-[#2f2f2f] rounded-lg px-3 py-2 text-sm text-gray-300 placeholder-gray-700 focus:outline-none focus:border-red-600/50"
                  />
                </div>
              ...
              <button
                onClick={handleSave}
                disabled={saving || !form.address_text}
          ...
          <div className="bg-[#111] border border-[#1f1f1f] rounded-xl w-full max-w-sm p-6 space-y-4">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-6 py-2 rounded-lg border border-[#2a2a2a] text-gray-400 hover:text-white text-sm font-medium transition-all"
              >
                No
              </button>
              <button
                onClick={confirm.onYes}
                className="px-6 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white text-sm font-medium transition-all"
              >
                Yes
              </button>
            </div>
