/**
 * features/superadmin/pages/SuperAdminPage.jsx
 *
 * Full user management + system health tracker for SuperAdmins.
 * Extracted logic into useUserManagement hook.
 */
        ...
        <>
          ...
          {editingUser && (
            <UserEditModal
              ...
              onSave={(id, payload) => saveUserEdit(id, payload).then(() => setEditingUser(null)).catch(() => {})}
            />
          )}
        </>
      )}
