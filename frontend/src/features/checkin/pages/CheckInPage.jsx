/**
 * features/checkin/pages/CheckInPage.jsx
 *
 * Full Check-In portal refactored to use useCheckIn hook.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-[#111] border border-[#1f1f1f] rounded-xl p-4 text-center">
          <div className="text-2xl font-bold text-gray-400">{checkedOutCount}</div>
