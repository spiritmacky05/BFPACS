 ...
 * pages/Fleet.jsx
 *
 * Fleet management — shows registered users as fleet/responder units (from bfpacs_update)
 * with ACS status tracking, plus the existing fleet vehicle list with GPS and movement logs.
 */

import { useState, useEffect } from 'react';
import { Truck, Search, Filter, MapPin, RefreshCw, Plus, X } from 'lucide-react';
